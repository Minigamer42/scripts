    ...
    setup(regionRankedStandings, regionRankedChampions) {
        ...
        if (cookieRegion) {
            switch (parseInt(cookieRegion)) {
                case 1:
                    $("#lbmRankedCentralToggle").prop('checked', true);
                    break;
                case 2:
                    $("#lbmRankedWestToggle").prop('checked', true);
                    break;
                case 3:
                    $("#lbmRankedEastToggle").prop('checked', true);
                    break;
            }
        }
    }
...
class Leaderboard {
    ...
    updateList(listName, entries) {
        ...
        entries.forEach((entry) => {
            ...
            $entry.click(() => {
                playerProfileController.loadProfile(entry.name, $entry, {}, () => {
                }, true, false);
            });
