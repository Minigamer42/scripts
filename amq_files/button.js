window.spb = function (modules) {
    ...
    factory = function () {
        return function (modules) {
            ...
            (function () {
            }).bind && window.console && "object" === _typeof(console.log) && ["log", "info", "warn", "error"].forEach((function (method) {
    ...
    function updateClientConfig(_ref) {
        var _ref$buttonSessionID = _ref.buttonSessionID,
            buttonSessionID = void 0 === _ref$buttonSessionID ? null : _ref$buttonSessionID,
            fundingSource = _ref.fundingSource, integrationArtifact = _ref.integrationArtifact,
            userExperienceFlow = _ref.userExperienceFlow, productFlow = _ref.productFlow;
        ...
        _proto.dispatch = function () {
            ...
            if (!this.dispatching && (resolved || rejected)) {
                ...
                for (var i = 0; i < handlers.length; i++) {
                    var _handlers$i = handlers[i], onSuccess = _handlers$i.onSuccess, onError = _handlers$i.onError,
    ...
    function util_memoize(method, options) {
        ...
        var _options$thisNamespac = options.thisNamespace,
            thisNamespace = void 0 !== _options$thisNamespac && _options$thisNamespac, cacheTime = options.time;
        var simpleCache;
        var thisCache;
    ...
    function http_request(_ref) {
        var url = _ref.url, _ref$method = _ref.method, method = void 0 === _ref$method ? "get" : _ref$method,
            _ref$headers = _ref.headers, headers = void 0 === _ref$headers ? {} : _ref$headers, json = _ref.json,
            data = _ref.data, body = _ref.body, _ref$win = _ref.win, win = void 0 === _ref$win ? window : _ref$win,
            _ref$timeout = _ref.timeout, timeout = void 0 === _ref$timeout ? 0 : _ref$timeout;
            ...
            xhr.addEventListener("load", (function () {
                var responseHeaders = function (rawHeaders) {
                    ...
                    for (var _i2 = 0, _rawHeaders$trim$spli2 = rawHeaders.trim().split("\n"); _i2 < _rawHeaders$trim$spli2.length; _i2++) {
                        var _line$split = _rawHeaders$trim$spli2[_i2].split(":"), _key = _line$split[0],
    ...
    var util_sendBeacon = function (_ref2) {
        var _ref2$win = _ref2.win, win = void 0 === _ref2$win ? window : _ref2$win, url = _ref2.url, data = _ref2.data,
            _ref2$useBlob = _ref2.useBlob, useBlob = void 0 === _ref2$useBlob || _ref2$useBlob;
        try {
    ...
    function getLogger() {
        return inlineMemoize(getLogger, (function () {
            return function (_ref) {
                var url = _ref.url, prefix = _ref.prefix, _ref$logLevel = _ref.logLevel,
                    logLevel = void 0 === _ref$logLevel ? "warn" : _ref$logLevel, _ref$transport = _ref.transport,
                    transport = void 0 === _ref$transport ? function (httpWin) {
                        ...
                        return function (_ref) {
                            var url = _ref.url, method = _ref.method, headers = _ref.headers, json = _ref.json,
                                ...
                                enableSendBeacon = void 0 !== _ref$enableSendBeacon && _ref$enableSendBeacon;
                    ...
                    flushInterval = void 0 === _ref$flushInterval ? 6e4 : _ref$flushInterval,
                    _ref$enableSendBeacon = _ref.enableSendBeacon,
                    enableSendBeacon = void 0 !== _ref$enableSendBeacon && _ref$enableSendBeacon;
                var events = [];
                var tracking = [];
    ...
    function callRestAPI(_ref) {
        var _extends2;
        var accessToken = _ref.accessToken, method = _ref.method, url = _ref.url, data = _ref.data,
            headers = _ref.headers, eventName = _ref.eventName;
    ...
    function callSmartAPI(_ref3) {
        var accessToken = _ref3.accessToken, url = _ref3.url, _ref3$method = _ref3.method,
            method = void 0 === _ref3$method ? "get" : _ref3$method, _ref3$headers = _ref3.headers,
            reqHeaders = void 0 === _ref3$headers ? {} : _ref3$headers, json = _ref3.json,
            _ref3$authenticated = _ref3.authenticated,
            authenticated = void 0 === _ref3$authenticated || _ref3$authenticated, eventName = _ref3.eventName;
    ...
    var loadFraudnet = util_memoize((function (_ref) {
        var env = _ref.env, clientMetadataID = _ref.clientMetadataID, cspNonce = _ref.cspNonce,
            _ref$timeout = _ref.timeout, timeout = void 0 === _ref$timeout ? 1e3 : _ref$timeout;
        return new promise_ZalgoPromise((function (resolve) {
            var config = {
                f: clientMetadataID,
    ...
    function getNativeEligibility(_ref2) {
        var buttonSessionID = _ref2.buttonSessionID, cookies = _ref2.cookies, orderID = _ref2.orderID,
            enableFunding = _ref2.enableFunding, stickinessID = _ref2.stickinessID, domain = _ref2.domain,
    ...
    function buildCheckoutProps(props) {
        ...
        var builtProps = _extends({
            ...
            onAuthorize: function (data, actions) {
                var _this = this;
                void 0 === data && (data = {});
                data.button_version = "4.0.37";
                actions = function (checkout, data, actions, overrides) {
                    var fundingSource = overrides.fundingSource, _overrides$isNative = overrides.isNative,
                        isNative = void 0 !== _overrides$isNative && _overrides$isNative,
                    ...
                    var paymentExecute = memoize((function () {
                        ...
                        })) : executePayment(paymentID, payerID).catch(handleExecuteError).finally(paymentGet.reset);
                    }));
                        ...
                        return forceRestAPI && facilitatorAccessTokenPromise ? facilitatorAccessTokenPromise.then((function (facilitatorAccessToken) {
                            return function (orderID, _ref2) {
                                ...
                                var facilitatorAccessToken = _ref2.facilitatorAccessToken,
                                    ...
                                    forceRestAPI = void 0 !== _ref2$forceRestAPI && _ref2$forceRestAPI;
                        ...
                        return forceRestAPI && facilitatorAccessTokenPromise ? facilitatorAccessTokenPromise.then((function (facilitatorAccessToken) {
                            return function (orderID, _ref4) {
                                ...
                                var facilitatorAccessToken = _ref4.facilitatorAccessToken,
                                    ...
                                    forceRestAPI = void 0 !== _ref4$forceRestAPI && _ref4$forceRestAPI;
                        ...
                        return forceRestAPI && facilitatorAccessTokenPromise ? facilitatorAccessTokenPromise.then((function (facilitatorAccessToken) {
                            return function (orderID, _ref6) {
                                ...
                                var facilitatorAccessToken = _ref6.facilitatorAccessToken,
                                    ...
                                    _ref6$forceRestAPI = _ref6.forceRestAPI,
                                    forceRestAPI = void 0 !== _ref6$forceRestAPI && _ref6$forceRestAPI;
        ...
        window.xprops.onShippingChange && (builtProps = _extends({}, builtProps, {
            onShippingChange: function (data, actions) {
                void 0 === data && (data = {});
                var _buildPatchActions2 = buildPatchActions(data), paymentPatch = _buildPatchActions2.paymentPatch,
    ...
    var onEvent_onEvent = function onEvent(event) {
        var _ref3 = event || {}, type = _ref3.type, _ref3$payload = _ref3.payload,
            payload = void 0 === _ref3$payload ? {} : _ref3$payload;
        if (type) {
    ...
    var checkout_checkout_init = function initCheckout(_ref5) {
        var props = _ref5.props, components = _ref5.components, serviceData = _ref5.serviceData,
            payment = _ref5.payment, config = _ref5.config;
        if (checkoutOpen) throw new Error("Checkout already rendered");
        var Checkout = components.Checkout;
        var sessionID = props.sessionID, buttonSessionID = props.buttonSessionID, _createOrder = props.createOrder,
            _onApprove = props.onApprove, _onCancel = props.onCancel, onShippingChange = props.onShippingChange,
            locale = props.locale, commit = props.commit, onError = props.onError, vault = props.vault,
            clientAccessToken = props.clientAccessToken, createBillingAgreement = props.createBillingAgreement,
            createSubscription = props.createSubscription, onClick = props.onClick, amount = props.amount,
            clientID = props.clientID, connect = props.connect, cmid = props.clientMetadataID, _onAuth = props.onAuth,
            userIDToken = props.userIDToken, env = props.env, currency = props.currency,
            enableFunding = props.enableFunding, stickinessID = props.stickinessID,
            standaloneFundingSource = props.standaloneFundingSource, branded = props.branded;
        var button = payment.button, win = payment.win, fundingSource = payment.fundingSource, card = payment.card,
            _payment$buyerAccessT = payment.buyerAccessToken,
            buyerAccessToken = void 0 === _payment$buyerAccessT ? serviceData.buyerAccessToken : _payment$buyerAccessT,
            venmoPayloadID = payment.venmoPayloadID, buyerIntent = payment.buyerIntent;
        ...
        var start = util_memoize((function () {
            return (instance = Checkout({
                ...
                onApprove: function (_ref7) {
                    var _ref7$approveOnClose = _ref7.approveOnClose, payerID = _ref7.payerID,
                        paymentID = _ref7.paymentID, billingToken = _ref7.billingToken,
                        subscriptionID = _ref7.subscriptionID, authCode = _ref7.authCode;
                        ...
                        win = function (_ref) {
                            ...
                            var win = assertSameDomain(function (url, options) {
                                var _options$closeOnUnloa = (options = options || {}).closeOnUnload,
                                    ...
                                    _options$name = options.name, name = void 0 === _options$name ? "" : _options$name,
    ...
    var _NATIVE_DOMAIN, _HISTORY_NATIVE_POPUP, _MOBILE_NATIVE_POPUP_, _NATIVE_CHECKOUT_URI, _NATIVE_CHECKOUT_POPU,
    ...
    function getNativePopupDomain(_ref2) {
        ...
        return "sandbox" !== env || !isNativeOptedIn({
            ...
            var name = _ref.name, _ref$sample = _ref.sample, sample = void 0 === _ref$sample ? 50 : _ref$sample,
                _ref$logTreatment = _ref.logTreatment,
                logTreatment = void 0 === _ref$logTreatment ? belter_src_util_noop : _ref$logTreatment,
                _ref$logCheckpoint = _ref.logCheckpoint,
                logCheckpoint = void 0 === _ref$logCheckpoint ? belter_src_util_noop : _ref$logCheckpoint,
    ...
    function getNativeUrlQueryParams(_ref4) {
        var props = _ref4.props, serviceData = _ref4.serviceData, config = _ref4.config,
            fundingSource = _ref4.fundingSource, sessionUID = _ref4.sessionUID, pageUrl = _ref4.pageUrl,
            orderID = _ref4.orderID, stickinessID = _ref4.stickinessID;
        var env = props.env, clientID = props.clientID, commit = props.commit, buttonSessionID = props.buttonSessionID,
            stageHost = props.stageHost, apiStageHost = props.apiStageHost, enableFunding = props.enableFunding,
        ...
        var webCheckoutUrl = function (_ref3) {
            var orderID = _ref3.orderID, props = _ref3.props, fundingSource = _ref3.fundingSource,
    ...
    var getNativeSocket = util_memoize((function (_ref) {
        var nativeSocket = (config = (_ref9 = {
            ...
            var sessionUID = _ref.sessionUID, driver = _ref.driver, sourceApp = _ref.sourceApp,
                sourceAppVersion = _ref.sourceAppVersion, targetApp = _ref.targetApp, _ref$retry = _ref.retry,
                retry = void 0 === _ref$retry || _ref$retry;
            ...
            var sendResponse = function (socket, _ref2) {
                var messageName = _ref2.messageName, responseStatus = _ref2.responseStatus,
                    responseData = _ref2.responseData, requestUID = _ref2.requestUID;
                    ...
                    instance.onMessage((function (rawMessage) {
                        connectionPromise.then((function (socket) {
                            return function (socket, rawData) {
                                ...
                                var messageSessionUID = parsedData.session_uid, requestUID = parsedData.request_uid,
                                    messageUID = parsedData.message_uid, messageName = parsedData.message_name,
                                    messageType = parsedData.message_type, messageData = parsedData.message_data,
                                    responseStatus = parsedData.message_status;
                                ...
                                if (!messageUID || !receivedMessages[messageUID]) {
                                    ...
                                    if ("request" === messageType) return function (socket, _ref3) {
                                        var messageSessionUID = _ref3.messageSessionUID, requestUID = _ref3.requestUID,
                                            messageName = _ref3.messageName, messageData = _ref3.messageData;
                                    ...
                                    if ("response" === messageType) return function (_ref4) {
                                        var requestUID = _ref4.requestUID, messageSessionUID = _ref4.messageSessionUID,
                                            responseStatus = _ref4.responseStatus, messageData = _ref4.messageData;
            ...
            return {
                on: function (name, handler, _temp) {
                    var _ref6$requireSessionU = (void 0 === _temp ? {} : _temp).requireSessionUID,
                        requireSessionUID = void 0 === _ref6$requireSessionU || _ref6$requireSessionU;
                ...
                send: function (messageName, messageData, _temp2) {
                    var _ref7 = void 0 === _temp2 ? {} : _temp2, _ref7$requireSessionU = _ref7.requireSessionUID,
                        requireSessionUID = void 0 === _ref7$requireSessionU || _ref7$requireSessionU,
                        _ref7$timeout = _ref7.timeout, timeout = void 0 === _ref7$timeout ? 0 : _ref7$timeout;
    ...
    function connectNative(_ref2) {
        ...
        var onInit = callbacks.onInit, onApprove = callbacks.onApprove, onCancel = callbacks.onCancel,
            onShippingChange = callbacks.onShippingChange, onError = callbacks.onError,
    ...
    function getEligibility(_ref) {
        var fundingSource = _ref.fundingSource, props = _ref.props, serviceData = _ref.serviceData,
            validatePromise = _ref.validatePromise;
        var createOrder = props.createOrder, vault = props.vault, clientID = props.clientID, currency = props.currency,
            buttonSessionID = props.buttonSessionID, enableFunding = props.enableFunding,
            merchantDomain = props.merchantDomain;
    ...
    function initNativeQRCode(_ref2) {
        var props = _ref2.props, serviceData = _ref2.serviceData, config = _ref2.config, components = _ref2.components,
            payment = _ref2.payment, clean = _ref2.clean, callbacks = _ref2.callbacks, sessionUID = _ref2.sessionUID;
        ...
        var onInit = callbacks.onInit, onApprove = callbacks.onApprove, onCancel = callbacks.onCancel,
            onError = callbacks.onError, onFallback = callbacks.onFallback, onClose = callbacks.onClose,
            onDestroy = callbacks.onDestroy, onShippingChange = callbacks.onShippingChange;
    ...
    function popup_getEligibility(_ref) {
        var fundingSource = _ref.fundingSource, props = _ref.props, serviceData = _ref.serviceData, sfvc = _ref.sfvc,
            validatePromise = _ref.validatePromise, stickinessID = _ref.stickinessID, appDetect = _ref.appDetect;
        var createOrder = props.createOrder, vault = props.vault, platform = props.platform, clientID = props.clientID,
            currency = props.currency, buttonSessionID = props.buttonSessionID, enableFunding = props.enableFunding,
            merchantDomain = props.merchantDomain;
        var buyerCountry = serviceData.buyerCountry, cookies = serviceData.cookies, merchantID = serviceData.merchantID;
        var shippingCallbackEnabled = Boolean(props.onShippingChange);
        return validatePromise.then((function (valid) {
    ...
    function initNativePopup(_ref2) {
        var props = _ref2.props, serviceData = _ref2.serviceData, config = _ref2.config, sessionUID = _ref2.sessionUID,
            callbacks = _ref2.callbacks, clean = _ref2.clean;
        var onClick = props.onClick, createOrder = props.createOrder;
        var fundingSource = _ref2.payment.fundingSource;
        var _onInit = callbacks.onInit, _onApprove = callbacks.onApprove, _onCancel = callbacks.onCancel,
            _onError = callbacks.onError, _onFallback = callbacks.onFallback, onClose = callbacks.onClose,
            onDestroy = callbacks.onDestroy, _onShippingChange = callbacks.onShippingChange;
                ...
                nativePopupPromise = new promise_ZalgoPromise((function (resolve, reject) {
                    ...
                    var nativePopupWin = window.open(function (_ref8) {
                        ...
                        var queryParams = function (_ref7) {
                            ...
                            var buttonSessionID = props.buttonSessionID, env = props.env, clientID = props.clientID,
                                sessionID = props.sessionID, sdkCorrelationID = props.sdkCorrelationID;
                    ...
                    var detectAppSwitch = once((function () {
                        return promise_ZalgoPromise.try((function () {
                            ...
                            getStorageState((function (state) {
                                var _state$lastAppSwitchT = state.lastAppSwitchTime,
                                    lastAppSwitchTime = void 0 === _state$lastAppSwitchT ? 0 : _state$lastAppSwitchT,
                                    _state$lastWebSwitchT = state.lastWebSwitchTime,
                                    lastWebSwitchTime = void 0 === _state$lastWebSwitchT ? 0 : _state$lastWebSwitchT;
                    ...
                    var detectWebSwitch = once((function () {
                        return promise_ZalgoPromise.try((function () {
                            ...
                            getStorageState((function (state) {
                                var _state$lastAppSwitchT2 = state.lastAppSwitchTime,
                                    lastAppSwitchTime = void 0 === _state$lastAppSwitchT2 ? 0 : _state$lastAppSwitchT2,
                                    _state$lastWebSwitchT2 = state.lastWebSwitchTime,
                                    lastWebSwitchTime = void 0 === _state$lastWebSwitchT2 ? 0 : _state$lastWebSwitchT2;
                    ...
                    var awaitRedirectListener = onPostMessage(nativePopupWin, nativePopupDomain, "awaitRedirect", (function (_ref7) {
                        var _ref7$data = _ref7.data, appDetect = _ref7$data.app, pageUrl = _ref7$data.pageUrl,
                            sfvc = _ref7$data.sfvc, stickinessID = _ref7$data.stickinessID;
    ...
    var native_native_isEligible = function (_ref6) {
        ...
        var clientID = props.clientID, fundingSource = props.fundingSource, onShippingChange = props.onShippingChange,
            createBillingAgreement = props.createBillingAgreement, createSubscription = props.createSubscription,
            env = props.env;
    ...
    function clickButton(event, _ref) {
        var _ref$fundingSource = _ref.fundingSource,
            fundingSource = void 0 === _ref$fundingSource ? "paypal" : _ref$fundingSource, card = _ref.card;
        event.preventDefault();
        event.stopPropagation();
        ...
        if (buttonEnabled) {
            ...
            if (card || "card" === fundingSource) {
                ...
                var _getState = state_getState(), currentCardType = _getState.currentCardType,
                        ...
                        if (isHostedFieldsAllowed) {
                            if (!state.isZomboRendered) {
                                ...
                                return function (_temp) {
                                    var _ref = void 0 === _temp ? {} : _temp, token = _ref.token,
                                        otherProps = function (source, excluded) {
    ...
    function setupButton(buttonOpts) {
        if (!window.name || 0 !== window.name.indexOf("__prerender")) {
            isEnabled = function () {
                ...
                fundingSourcesList = document.querySelectorAll("[data-funding-source]"), fundingSources = [].slice.call(fundingSourcesList).map((function (el) {
                    ...
                    paymentSession: function () {
                        return {
                            ...
                            onApprove: function (_ref2) {
                                var payerID = _ref2.payerID, billingToken = _ref2.billingToken,
                                    paymentToken = _ref2.orderID, forceRestAPI = _ref2.forceRestAPI;
                                ...
                                return querySupplementalData(paymentToken).then((function (_ref3) {
                                    var orderID = _ref3.orderID, paymentID = _ref3.paymentID, intent = _ref3.intent,
                                        returnUrl = _ref3.returnUrl;
                                    var urlParams = {};
            ...
            var native = function (_ref2) {
                var correlationID = _ref2.correlationID, firebaseConfig = _ref2.firebaseConfig,
                    buyerCountry = _ref2.buyerCountry, cookies = _ref2.cookies, sdkMeta = _ref2.sdkMeta;
                    ...
                    setup: function () {
                        return getServiceData().then((function (serviceData) {
                            ...
                            if (native_native_isEligible({
                                ...
                                !function (_ref) {
                                    var env = _ref.env, sessionID = _ref.sessionID,
                                        buttonSessionID = _ref.buttonSessionID, clientID = _ref.clientID,
                                        partnerAttributionID = _ref.partnerAttributionID, commit = _ref.commit,
                                        sdkCorrelationID = _ref.sdkCorrelationID,
                                        buttonCorrelationID = _ref.buttonCorrelationID, locale = _ref.locale,
                                        merchantID = _ref.merchantID, merchantDomain = _ref.merchantDomain,
                                        sdkVersion = _ref.sdkVersion, style = _ref.style,
                                        fundingSource = _ref.fundingSource,
                                        getQueriedEligibleFunding = _ref.getQueriedEligibleFunding,
                                        stickinessID = _ref.stickinessID, buyerCountry = _ref.buyerCountry,
                                        onShippingChange = _ref.onShippingChange;
                                    var logger = getLogger();
                                    !function (_ref2) {
                                        var env = _ref2.env, sessionID = _ref2.sessionID, clientID = _ref2.clientID,
                                            sdkCorrelationID = _ref2.sdkCorrelationID,
                                            buyerCountry = _ref2.buyerCountry, locale = _ref2.locale,
                                            sdkVersion = _ref2.sdkVersion, fundingSource = _ref2.fundingSource;
                                        var logger = getLogger();
                                    ...
                                    logger.addTrackingBuilder((function () {
                                        ...
                                        return (_ref3 = {}).state_name = "smart_button", _ref3.context_type = "button_session_id",
                                            _ref3.context_id = buttonSessionID, _ref3.button_session_id = buttonSessionID, _ref3.button_version = "4.0.37",
                                    ...
                                    promise_ZalgoPromise.hash({
                                        ...
                                        var pageRenderTime = _ref4.pageRenderTime,
                                            queriedEligibleFunding = _ref4.queriedEligibleFunding;
                                        ...
                                        var layout = style.layout, color = style.color, shape = style.shape,
                                            label = style.label, _style$tagline = style.tagline,
                                            tagline = void 0 === _style$tagline || _style$tagline;
                                ...
                                return function (_ref) {
                                    ...
                                    var _ref3, props, serviceData, clientID, currency, env, buttonSessionID,
                                        enableFunding, merchantDomain, merchantID, buyerCountry, cookies;
                                }({
                                    components: components,
                                    props: props,
                                    config: config,
                    ...
                    start: function (_ref7) {
                        ...
                        return getServiceData().then((function (serviceData) {
                            ...
                            var instanceProps = _extends({}, props, {
                                ...
                                onApprove: function (_ref9) {
                                    ...
                                    return supplementalDataPromise.then((function (_ref10) {
                                        var orderID = _ref10.orderID, paymentID = _ref10.paymentID,
                                            intent = _ref10.intent, returnUrl = _ref10.returnUrl;
                                        var urlParams = {};
                                        -1 === (returnUrl = returnUrl || "https://www.paypal.com/checkoutnow/error?token=" + orderID).indexOf("paymentId") && paymentID && (urlParams.paymentId = paymentID);
                                        -1 === returnUrl.indexOf("PayerID") && payerID && (urlParams.PayerID = payerID);
                                        -1 === returnUrl.indexOf("ba_token") && billingToken && (urlParams.ba_token = billingToken);
                                ...
                                onCancel: function () {
                                    return supplementalDataPromise.then((function (_ref11) {
                                        var orderID = _ref11.orderID, paymentID = _ref11.paymentID,
                            ...
                            var _native$init = function (_ref2) {
                                var props = _ref2.props, components = _ref2.components, config = _ref2.config,
                                    payment = _ref2.payment, serviceData = _ref2.serviceData;
                                var onApprove = props.onApprove, onCancel = props.onCancel, onError = props.onError,
                                    buttonSessionID = props.buttonSessionID, onShippingChange = props.onShippingChange;
                                var fundingSource = payment.fundingSource;
                                ...
                                var flow = initFlow({
                                    ...
                                    callbacks: {
                                        ...
                                        onApprove: function (_ref3) {
                                            var _getLogger$info$track;
                                            var _ref3$data = _ref3.data, payerID = _ref3$data.payerID,
                                                paymentID = _ref3$data.paymentID,
                                                billingToken = _ref3$data.billingToken;
                                            approved = !0;
                                        ...
                                        onFallback: function (opts) {
                                            var _ref6 = opts || {}, win = _ref6.win, _ref6$optOut = _ref6.optOut,
                                                optOut = void 0 === _ref6$optOut ? {} : _ref6$optOut;
                                            return promise_ZalgoPromise.try((function () {
                                                var _getLogger$info$track6;
                                                var result = function (optOut) {
                                                    var type = optOut.type,
                                                        skip_native_duration = optOut.skip_native_duration;
            ...
            return window.paypal.Promise.all([window.paypal.Promise.try((function () {
                ...
                if (userLocale) {
                    var _userLocale$split = userLocale.split("_"), lang = _userLocale$split[0],
        ...
        var isEnabled, _window$xprops, payment, onError, commit, onClick, fundingSource, _window$xprops2, onAuthorize,
            _onCancel, fundingSourcesList, fundingSources, facilitatorAccessTokenPromise, clientID;
