...
function HostModal() {
	...
	this.extraGuessTimeSliderCombo;
	this.extraGuessTimeRangeSliderCombo;
	this.extraGuessTimeRandomSwitch;
...
HostModal.prototype.setupExtraGuessTime = function () {
	this.extraGuessTimeSliderCombo = new SliderTextCombo($("#mhExtraGuessTime"), $("#mhExtraGuessTimeText"), {
		min: 0,
		max: 15,
		value: 0,
		formatter: function (value) {
	...
	this.extraGuessTimeRangeSliderCombo = new SliderTextCombo(
		$("#mhExtraGuessTimeRange"),
		[$("#mhExtraGuessTimeMin"), $("#mhExtraGuessTimeMax")],
		{
			min: 0,
			max: 15,
			value: [0, 15],
	...
	this.extraGuessTimeRandomSwitch = new Switch($("#mhExtraGuessTimeRandomSwitch"));
	this.extraGuessTimeRandomSwitch.addContainerToggle($("#mhExtraGuessTimeRangeContainer"), $("#mhExtraGuessTimeSpecificContainer"));
};
...
HostModal.prototype.relayoutQuizTab = function () {
	...
	this.extraGuessTimeSliderCombo.relayout();
	this.inventorySizeSliderCombo.relayout();
	this.lootingTimeSliderCombo.relayout();
	this.lifeSliderCombo.relayout();
	this.$samplePoint.slider("relayout");
...
HostModal.prototype.getSettings = function (onlyValidateStaticSettings) {
	...
	return {
		...
		extraGuessTime: {
			randomOn: this.extraGuessTimeRandomSwitch.getOn(),
			standardValue: this.extraGuessTimeSliderCombo.getValue(),
			randomValue: this.extraGuessTimeRangeSliderCombo.getValue(),
		},
...
HostModal.prototype.updateSetting = function (setting, change) {
	...
	switch (setting) {
		...
		case "guessTime":
			...
			break;
		case "extraGuessTime":
			this.extraGuessTimeSliderCombo.setValue(change.standardValue);
			this.extraGuessTimeRangeSliderCombo.setValue(change.randomValue);
			this.extraGuessTimeRandomSwitch.setOn(change.randomOn);
			break;
		case "scoreType":
