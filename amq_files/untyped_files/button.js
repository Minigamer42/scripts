window.spb = function(modules) {
    ...
    function setupButton(buttonOpts) {
        ...
        var isEnabled, _window$xprops, payment, onError, commit, onClick, fundingSource, _window$xprops2, onAuthorize, _onCancel, fundingSourcesList, fundingSources, facilitatorAccessTokenPromise, clientID;
