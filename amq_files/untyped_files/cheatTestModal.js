...
class CheatTestModal {
	constructor() {
		...
		this.$openCloseNoticeButton = $("#cheatChallengeNoticeOpenClose");
		this.$openCloseChevarons = $(".cheatChallengeOpenCloseChevron");
		...
		this.$openCloseNoticeButton.click(() => {
			if(this.noticeOpen) {
				this.$openCloseChevarons.removeClass('fa-chevron-left');
				this.$openCloseChevarons.addClass('fa-chevron-right');
				this.$triggerContainer.removeClass('open');
				this.noticeOpen = false;
			} else {
				this.$openCloseChevarons.removeClass('fa-chevron-right');
				this.$openCloseChevarons.addClass('fa-chevron-left');
				this.$triggerContainer.addClass('open');
				this.noticeOpen = true;
			}
		});
