...
!function (t,
    ...
    return function (t) {
        ...
        t.exports = r, r.prototype.on = r.prototype.addEventListener = function (t,
                                                                                 e) {
        ...
        }, r.prototype.off = r.prototype.removeListener = r.prototype.removeAllListeners = r.prototype.removeEventListener = function (t,
                                                                                                                                       e) {
        ...
        }, e.reconstructPacket = function (t,
                                           e) {
        ...
        }, o.prototype.doWrite = function (t,
                                           e) {
        ...
        e.encodePacket = function (t, e, n, i) {
            ...
            var s = h(t);
            return n && s ? k && !m ? e.encodePayloadAsBlob(t, r) : e.encodePayloadAsArrayBuffer(t, r) : t.length ? void c(t, i, function (t,
                                                                                                                                           e) {
                return r(e.join(''));
            }) : r('0:');
