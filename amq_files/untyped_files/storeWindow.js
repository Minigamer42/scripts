...
class StoreWindow {
	...
	getAllAvatars() {
		return this.topBar.characters.map(character => character.avatars).flat();
	}
	...
	showTicketStore() {
		...
		this.mainContainer.displayTickets();
		let ticketController = this.topBar.tickets;
		ticketController.handleDisplayed();
		ticketController.changeToBuy();
	}
}
