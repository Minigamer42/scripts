...
class Tutorial {
	constructor() {
		...
		this.nexusCityOverviewRow;
		this.nexusDungeonModeRow;
		this.nexusDungeonLobbyRow;
		this.nexusAvatarSelectionRow;
		this.nexusDungeonMapRow;
		this.nexusDungeonCombatRow;
		this.nexusDungeonRewardsRow;
		this.nexusCraftingStationRow;
		this.nexusWorkshopRow;
		this.nexusRuneSetupRow;
	...
	setup(tutorialState) {
		...
		this.nexusCityOverviewRow = new TutorialModalNexusRow(
			$("#tmCityOverviewRow"),
			nexusTutorialController.NEXUS_TUTORIAL_IDS.CITY_OVERVIEW
		);
		this.nexusDungeonModeRow = new TutorialModalNexusRow(
			$("#tmDungeonModeRow"),
			nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_MODE
		);
		this.nexusDungeonLobbyRow = new TutorialModalNexusRow(
			$("#tmDungeonLobbyRow"),
			nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_LOBBY
		);
		this.nexusAvatarSelectionRow = new TutorialModalNexusRow(
			$("#tmAvatarSelectionRow"),
			nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_AVATAR_SELECTION,
		);
		this.nexusDungeonMapRow = new TutorialModalNexusRow(
			$("#tmDungeonMapRow"),
			nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_MAP
		);
		this.nexusDungeonCombatRow = new TutorialModalNexusRow(
			$("#tmDungeonCombatRow"),
			nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_COMBAT
		);
		this.nexusDungeonRewardsRow = new TutorialModalNexusRow(
			$("#tmDungeonRewardsRow"),
			nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_REWARDS
		);
		this.nexusCraftingStationRow = new TutorialModalNexusRow(
			$("#tmCraftingStationRow"),
			nexusTutorialController.NEXUS_TUTORIAL_IDS.CRAFTING_STATION
		);
		this.nexusWorkshopRow = new TutorialModalNexusRow(
			$("#tmWorkshopRow"),
			nexusTutorialController.NEXUS_TUTORIAL_IDS.WORKSHOP
		);
		this.nexusRuneSetupRow = new TutorialModalNexusRow(
			$("#tmRuneSetupRow"),
			nexusTutorialController.NEXUS_TUTORIAL_IDS.RUNE_SETUP
		);
		this.updateNexusRowStates();
	}
	...
	updateNexusRowStates() {
		if (this.state.nexusCityOverview) {
			this.nexusCityOverviewRow.setCompleted();
		}
		if (this.state.nexusDungeonMode) {
			this.nexusDungeonModeRow.setCompleted();
		}
		if (this.state.nexusDungeonLobby) {
			this.nexusDungeonLobbyRow.setCompleted();
		}
		if (this.state.nexusAvatarSelection) {
			this.nexusAvatarSelectionRow.setCompleted();
		}
		if (this.state.nexusDungeonMap) {
			this.nexusDungeonMapRow.setCompleted();
		}
		if (this.state.nexusDungeonCombat) {
			this.nexusDungeonCombatRow.setCompleted();
		}
		if (this.state.nexusDungeonRewards) {
			this.nexusDungeonRewardsRow.setCompleted();
		}
		if (this.state.nexusCraftingStation) {
			this.nexusCraftingStationRow.setCompleted();
		}
		if (this.state.nexusWorkshop) {
			this.nexusWorkshopRow.setCompleted();
		}
		if (this.state.nexusRuneSetup) {
			this.nexusRuneSetupRow.setCompleted();
		}
	}

	nexusTutorialCompleted(tutorialId) {
		socket.sendCommand({
			type: "nexus",
			command: "tutorial completed",
			data: {
				tutorialId,
			},
		});
		switch (tutorialId) {
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.CITY_OVERVIEW:
				this.state.nexusCityOverview = true;
				this.nexusCityOverviewRow.setCompleted();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_MODE:
				this.state.nexusDungeonMode = true;
				this.nexusDungeonModeRow.setCompleted();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_LOBBY:
				this.state.nexusDungeonLobby = true;
				this.nexusDungeonLobbyRow.setCompleted();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_AVATAR_SELECTION:
				this.state.nexusAvatarSelection = true;
				this.nexusAvatarSelectionRow.setCompleted();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_MAP:
				this.state.nexusDungeonMap = true;
				this.nexusDungeonMapRow.setCompleted();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_COMBAT:
				this.state.nexusDungeonCombat = true;
				this.nexusDungeonCombatRow.setCompleted();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_REWARDS:
				this.state.nexusDungeonRewards = true;
				this.nexusDungeonRewardsRow.setCompleted();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.CRAFTING_STATION:
				this.state.nexusCraftingStation = true;
				this.nexusCraftingStationRow.setCompleted();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.WORKSHOP:
				this.state.nexusWorkshop = true;
				this.nexusWorkshopRow.setCompleted();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.RUNE_SETUP:
				this.state.nexusRuneSetup = true;
				this.nexusRuneSetupRow.setCompleted();
				break;
		}
	}

	nexusTutorialReset(tutorialId) {
		socket.sendCommand({
			type: "nexus",
			command: "tutorial reset",
			data: {
				tutorialId,
			},
		});
		switch (tutorialId) {
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.CITY_OVERVIEW:
				this.state.nexusCityOverview = false;
				this.nexusCityOverviewRow.setDisabled();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_MODE:
				this.state.nexusDungeonMode = false;
				this.nexusDungeonModeRow.setDisabled();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_LOBBY:
				this.state.nexusDungeonLobby = false;
				this.nexusDungeonLobbyRow.setDisabled();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_AVATAR_SELECTION:
				this.state.nexusAvatarSelection = false;
				this.nexusAvatarSelectionRow.setDisabled();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_MAP:
				this.state.nexusDungeonMap = false;
				this.nexusDungeonMapRow.setDisabled();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_COMBAT:
				this.state.nexusDungeonCombat = false;
				this.nexusDungeonCombatRow.setDisabled();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.DUNGEON_REWARDS:
				this.state.nexusDungeonRewards = false;
				this.nexusDungeonRewardsRow.setDisabled();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.CRAFTING_STATION:
				this.state.nexusCraftingStation = false;
				this.nexusCraftingStationRow.setDisabled();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.WORKSHOP:
				this.state.nexusWorkshop = false;
				this.nexusWorkshopRow.setDisabled();
				break;
			case nexusTutorialController.NEXUS_TUTORIAL_IDS.RUNE_SETUP:
				this.state.nexusRuneSetup = false;
				this.nexusRuneSetupRow.setDisabled();
				break;
		}
	}
		...
		this.TUTORIAL_STATES = {
			...
			FIRST_GAME: [
				...
				new TutorialState(
					this,
					"Gameplay",
					`To start out, select “Play", so we can get into a game.`,
					"FIRST_GAME",
					2,
					null,
					[$("#mainPage")],
				...
				new TutorialState(
					this,
					"Gameplay",
					`Now select “Multiplayer”. Don’t worry, I’m not going to put you up against veteran players from the get go.`,
					"FIRST_GAME",
					3,
					null,
					[$("#mainPage")],
					...
					[$("#gmsMultiplayer")],
					[$("#gmsMultiplayer")],
					[$("#gmsSinglePlayer"), $("#gmsNexus"), $("#gameModeSelector")],
					$("#gmsMultiplayer")
				),
				new TutorialState(
					this,
...
class TutorialState {
	...
	display() {
		...
		if (this.disableElements) {
			this.disableElements.forEach(($element) => {
				$element.addClass("tcDisableElement");
			});
		}
	...
	clearState() {
		...
		if (this.disableElements) {
			this.disableElements.forEach(($element) => {
				$element.removeClass("tcDisableElement");
			});
		}
...
class TutorialModalNexusRow extends TutorialModalRow {
	constructor($row, tutorialId) {
		super($row, () => {
			tutorial.nexusTutorialReset(tutorialId);
		});
	}
